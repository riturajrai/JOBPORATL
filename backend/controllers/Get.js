...
// GET /api/jobs/user/:userId - Fetch jobs posted by a user
...
// GET /api/jobs/:id/status - Check job status (saved, applied, reported)
...
// GET /api/userr/:candidateId - Fetch candidate profile (simplified)
...
// GET /api/users/:id/saved-jobs - Fetch saved jobs for a user
...
// GET /api/users/:id/applied-jobs - Fetch applied jobs for a user
...
// GET /api/users/:userId/notifications - Fetch user notifications
...
// GET /api/applications/job/:job_id - Fetch applications for a job
...
//1 GET /api/companies - Fetch all company profiles
...
// 2. GET /api/notifications/:userId - Fetch all notifications for a user
...
// GET /api/notifications/:userId/unread - Fetch unread notification count
